...
<link rel="shortcut icon" type="image/ico" href="favicon.ico">
	...
	<meta charset="utf-8">
	<meta name="keywords" content="A Blood Donation website to make the process of blood donation easier, cheaper and more convenient." />
	...
	<div class="top-bar_sub_w3layouts container-fluid">
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 log-icons mt-2">
				<p class="py-2"><i class="fas fa-phone"></i> Call us : +254 740 147 010</p>
			</div>
			
			<div class="col-md-4 col-sm-6 logo">
				<a class="navbar-brand" href="index.html">
					<img src="images/cute.png" style="width:35%">
					</i> Smart Donor</a>
			</div>
				...
				<ul class="rslides" id="slider1">
					...
					<li>
						<div class="banner-img two">
							<div class="bs-slider-overlay">
								<div class="banner-info text-center">
									<h4 style="color:aliceblue">Save time and Money!</h4>
									<h5 style="color:aliceblue">Be Smart With Smart Donor </h5>
									<a href="booking.html">Request Blood </a>
								</div>
							</div>
					...
					<li>
						<div class="banner-img three">
							<div class="bs-slider-overlay">
								<div class="banner-info text-center">
									<h4 style="color:aliceblue">Get your request</h4>
									<h5 style="color:aliceblue">To the right audience</h5>
									<a href="booking.html">Request Blood </a>
								</div>
							</div>
						</div>
...
<section class="about py-5">
	<div class="container py-lg-5 py-3">
		...
		<h5 class="heading mb-5 text-center">Smart Donor</h5>
		<div class="about-head text-center ">
			...
			<div class="row about-grids-bottom text-left">
				<div class="col-md-4 mb-md-0 mb-5 about-bottom-grid">
					<h4 class="mb-4">We enable you to get blood from donors without all the hustle of fruitless requests!</h4>
					<a href="about.html"> More About Us</a>	
				</div>
				<div class="col-md-4 about-bottom-grid">
					<p>Register as a donor and get notified every time a patient of your blood type around you needs blood.</p>
				</div>
				<div class="col-md-4 about-bottom-grid">
					<p>Forget the hustle of Radio, Twitter and Whatsapp Groups. Use Smart Donor and talk directly to the donors of your blood type around you</p>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid pt-lg-5">
		<div class="row">
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
				...
				<p>We make the process of blood donation a seamless and efficient activity through the use of technology</p>
				<a href="#" class="read">Know More <i class="fas fa-caret-right"></i></a>
			</div>
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 footer-grid-agileits-w3ls1 text-left">
				<h3 class="mb-sm-5 mb-4">Locate Us</h3>	
				<ul class="w3ls-footer-bottom-list">
					<li> <span class="fas fa-map-marker"></span> 3481 Nyeri Town, <br> Nyeri, Kenya </span></li>
					<li> <span class="fas fa-envelope"></span> <a href="mailto:deliveryman@example.com"> smartdonor@gmail.com</a> </li>
					<li> <span class="fas fa-phone"></span> +254 740 147 010 </li>
					<li> <span class="fas fa-fax"></span> +254 367 896 2449 </li>
					<li> <span class="fas fa-globe"></span> <a href="#"> www.smartdonor.com</a> </li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="login.php" method="post">
					...
					<div class="right-w3l">
						<input type="submit" class="form-control" name="btnLogin" value="Sign In">
					</div>
			...
			<div class="modal-body">
				<form action="reg.php" method="post">
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="User Name" name="recipient-rname" id="recipient-rname" required="">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="email" class="form-control" placeholder="Email" name="recipient-email" id="recipient-email" required="">
					</div>
					
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Mobile Number</label>
						<input type="text" class="form-control" placeholder="Mobile Number" name="recipient-mname" id="recipient-mname" required="">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">ID Number</label>
						<input type="text" class="form-control" placeholder="ID Number" name="recipient-iname" id="recipient-iname" required="">
					</div>
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Blood Group</label>
						<select name="recipient-bname" required class="form-control" id="recipient-bname">
					...
					<div class="form-group">
						<label for="recipient-name" class="col-form-label">Town</label>
						<input type="text" class="form-control" placeholder="Nearest Town" name="recipient-tname" id="recipient-tname" required="">
					</div>
					...
					<div class="right-w3l">
						<input type="submit" class="form-control" name="btnRegister" value="Register">
					</div>
				</form>
			</div>
		</div>
